<template>
  <div>
    ...
    <el-row :gutter="10" style="padding:10px;">
      ...
      <el-col :span="12">
        <locate :nearby-data="projectData" :active-value="activeValue" :is-locating="isLocating" :center="center" @confirm="confirm" @cancel="cancel"/>
      </el-col>
    </el-row>
  </div>
</template>
...
import {
  getImportationProjects, submitImportation, editImportationProjects
} from '@/api/data'
...
export default {
  ...
  methods: {
    ...
    confirm(type, center) {
      ...
      editImportationProjects(this.locatingObj.prj_no, this.locatingObj).then(response => {
        if (response.code === 200) {
          this.$message({
            type: 'success',
            message: '编辑成功!'
