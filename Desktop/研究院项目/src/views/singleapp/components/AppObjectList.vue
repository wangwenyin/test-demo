<template>
  <div class="margin10 ">
    <el-row v-if="detail" style="height:10px" />
    <el-row v-if="detail" class="search-box">
      ...
      <el-col :span="3">
        <el-select v-model="cxlx" class="search" size="small" placeholder="楼盘名称">
          <el-option label="楼盘名称" value="xmmc" />
          <el-option label="楼栋名称" value="ldmc" />
          <el-option label="户号" value="hh" />
    ...
    <el-table v-if="bulidingList" :row-class-name="tableRowClassName" :data="bulidingList" class="table" >
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-table :row-class-name="tableRowClassName" :data="getHoust(props.row.lddm)" style="width: 100%" >
            ...
            <el-table-column v-if="detail" label="操作" width="150" >
