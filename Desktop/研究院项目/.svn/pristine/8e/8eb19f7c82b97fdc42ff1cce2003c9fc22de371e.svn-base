<template>
  <div>
    <el-row class="search-container" style="padding: 5px" >
      <el-select v-model="searchOption.logType" style="width:120px;float:left;margin-left:10px;" placeholder="请选择" size="small" @change="onChangeValue" @keyup.enter.native="onInputEnter">
