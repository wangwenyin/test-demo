...
export default {
  ...
  methods: {
    ...
    getStructure(val) {
      ...
      this.loading = true
      const params = { 'district': this.district === '' ? null : this.district, 'subdistrict': this.subdistrict === '' ? null : this.subdistrict, 'parcel_no': this.parcel_no === '' ? null : this.parcel_no, 'struc_name': this.struc_name === '' ? null : this.struc_name, 'page': this.listQuery.page, 'limit': this.listQuery.limit }
