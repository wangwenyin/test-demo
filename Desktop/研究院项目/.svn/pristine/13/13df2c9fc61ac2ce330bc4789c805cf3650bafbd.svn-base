      ...
      <div v-if="project.cnt > 0" >
        <div v-for="item in caseList" :key="item.case_no" class="detail-item">
          <div class="detail-top">
            <span v-if="!caller || (caller && isViewDetail)" style="margin-right: 10px"/>
            <el-button v-if="caller && !isViewDetail" type="primary" size="small" circle icon="el-icon-plus" @click="onAddComparableClick(item)"/>
