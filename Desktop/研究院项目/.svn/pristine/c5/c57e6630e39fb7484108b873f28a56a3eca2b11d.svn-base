        ...
        <el-row :gutter="20" style="margin-top:20px;">
          ...
          <el-col :span="12">
            <el-form-item label="宗地面积：" prop="land_area">
              <el-input-number :precision="2" v-model.number="land.land_area" min="0" max="100000" size="small" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20" >
        ...
        <el-row :gutter="20" >
          <el-col :span="12">
            <el-form-item label="土地价格：" prop="land_price">
              <el-input-number :precision="2" v-model.number="land.land_price" min="0" max="100000000000" size="small" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row :gutter="20" >
          ...
          <el-col :span="12">
            <el-form-item label="容积率：" prop="plot_ratio">
              <el-input-number :precision="2" v-model.number="land.plot_ratio" min="0" max="1000" size="small" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20" >
          <el-col :span="12">
            <el-form-item label="建筑密度：" prop="built_density">
              <el-input-number :precision="2" v-model.number="land.built_density" min="0" max="1" size="small" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="土地使用年限：" prop="land_term">
              <el-input-number v-model.number="land.land_term " min="0" max="70" size="small" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20" >
        ...
        <el-row :gutter="20" >
          <el-col :span="24">
            <el-form-item label="地理位置：">
              <el-input v-model="land.address" maxlength="100" size="small" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
